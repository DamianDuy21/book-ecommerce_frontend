        ...
        return (
            ...
            <>
                <div className='container cart-container'>
                    ...
                    {step == 0 ? (<>
                        <ReceiptDetailReceipt type={1} data={receipt.products} shipment={receipt.shipPay} setStep={setStep} />
                    </>) : (<>
                        {step == 1 ? (<>
                            <ReceiptDetailInfo type={1} data={receipt} shipment={receipt.shipPay} setStep={setStep} />
                        </>) : (<>
