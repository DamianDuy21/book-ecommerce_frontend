...
const HomePage = () => {
    ...
    useEffect(() => {
        ...
        const getProducts = async () => {
            const responseLastestProducts = await getProductByRequest("limit=10&page=1&sort=-createdAt");
        ...
        return (
            <>
                <div className="container-homePage">
                    ...
                    <div className="filter-section common-wrapper" style={{ padding: "16px 16px 2px 16px" }}>
                        <div className="medium-title" style={{ marginBottom: "12px" }}>Tìm kiếm theo</div>
                    ...
                    <div className='common-wrapper' style={{ marginTop: "16px", padding: "16px 16px 24px 16px" }}>
                        <SliderList products={lastestProducts} title={"Sản phẩm mới"} related={"-createdAt"} />
                    </div>
                    <div className='common-wrapper' style={{ marginTop: "16px", padding: "16px 16px 24px 16px" }}>
                        <SliderList products={mostBuyProducts} title={"Sản phảm bán chạy"} related={"-sold"} />
                    </div>
                    <div className='common-wrapper' style={{ marginTop: "16px", marginBottom: "0px", padding: "16px 16px 24px 16px" }}>
                        <SliderList products={mostDiscountProducts} title={"Sản phẩm giảm giá nhiều"} related={"-discount"} />
                    </div>
                </div>
            </>
        );
