    ...
    const columns1 = [
        ...
        // },
        {
            ...
            render: (text, record, index) =>
                <div className="email-manage-users">
                    {record.email}
                </div>
            ,
        },
        ...
        },
        {
            ...
            render: (text, record, index) =>
                <div style={{ display: "flex", justifyContent: "center", width: "max-content" }}>
                    <span>{moment(parseInt(record.lastAccess, 10)).format('DD/MM/YYYY HH:mm:ss')}</span>
                </div>
            ,
        },
        {
            ...
            <>
                ...
                <div className="common-wrapper history-table">
                    <div style={{ display: "flex", justifyContent: "space-between", paddingRight: "4px", flexWrap: "wrap", gap: "6px" }}>
                        <div className="medium-title" style={{ marginBottom: "16px" }}>Danh sách người dùng</div>
