    ...
    const columns1 = [
        {
            ...
            dataIndex: '_id',
            key: '_id',
            render: (text, record, index) => <div><>{record._id}</></div>,
        },
        {
        ...
        },
        {
            ...
            render: (text, record, index) => (
                <div style={{ display: "flex", flexWrap: "wrap", gap: "6px", minWidth: "74px", justifyContent: "center" }}>
                    ...
                    {record.status == "Chờ duyệt" ? (<Button className='button-1' onClick={() => handleConfirm(record)}>
                        <CheckOutlined />
                    </Button>) : (<></>)}
                </div>
            )
    ...
    const columns2 = [
        {
            ...
            dataIndex: '_id',
            key: '_id',
            render: (text, record, index) => <div style={{ maxWidth: "102px" }}>{record._id}</div>,
        },
        {
            title: <div style={{ width: "max-content" }}>Trạng thái</div>,
            dataIndex: 'status',
            ...
            <>
                <div className="common-wrapper history-table">
                    <div style={{ display: "flex", justifyContent: "space-between", paddingRight: "4px", flexWrap: "wrap", gap: "6px" }}>
                        <div className="medium-title" style={{ marginBottom: "16px" }}>Danh sách đơn hàng</div>
