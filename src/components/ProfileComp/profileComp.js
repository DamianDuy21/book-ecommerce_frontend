...
const ProfileComp = (props) => {
  ...
  const onFinish = async (values) => {
    try {
        ...
        if (fileList[0].originFileObj) {
          ...
          if (uploadTask) {
            ...
            if (uploadTask.task.snapshot && uploadTask.task.snapshot.ref) {
              ...
              console.error(
                "Snapshot or snapshot.ref is undefined",
                uploadTask.task.snapshot
              );
            }
          } else {
      ...
      dispatch(
        doUpdateUser({
          avatar: newUser.data[0].avatar,
          userName: newUser.data[0].username,
          phone: newUser.data[0].phone,
          password: newUser.data[0].password,
          description: newUser.data[0].description,
        })
      );
      if (response.ec == 200) {
        setLoading(false);
    ...
    return (
      <>
        <div className="profile-page">
          <div
            className="statistics-section common-wrapper"
            ...
            >
              ...
              <div className="form-content">
                <div
                  ...
                  style={{ marginBottom: "16px" }}
                >
                  <div className="tiny-title" style={{ marginBottom: "10px" }}>
                    Avatar:
                  </div>
                  <Upload
