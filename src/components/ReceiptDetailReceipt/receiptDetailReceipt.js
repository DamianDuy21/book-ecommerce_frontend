...
import ReceiptDetailProductDetailModal from '../ReceiptDetailProductDetailModal/receiptDetailProductDetailModal';
import { useNavigate } from 'react-router-dom';
import moment from 'moment';
const ReceiptDetailReceipt = (props) => {
                ...
                <div className='product-quantity'>
                    <div className="quantity-section">
                        <div className="quantity">
                            ...
                            <div style={{ display: "flex", justifyContent: "center", width: "156px" }}>{record.quantity}</div>
                            {/* <Button
        ...
        <>
            <div className='cart-info'>
                ...
                <div className='cart-form common-wrapper'>
                    <div className='title medium-title' style={{ marginBottom: "8px" }}>Phiếu mua hàng <span className='small-title'>({moment(data.createdAt).format('HH:mm:ss DD/MM/YYYY')})</span></div>
                    <div style={{ display: "flex", justifyContent: "space-between", paddingRight: "4px", flexWrap: "wrap", gap: "6px" }}>
                        ...
                        <div className='tiny-title'>Số lượng sản phẩm: <span className='medium-title'>{data.length}</span></div>
                    </div>
                    <div className='table'>
                        {type === 1 ? (
                            <Table
...
export default ReceiptDetailReceipt;
