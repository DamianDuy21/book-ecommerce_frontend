...
const Headerr = (props) => {
  ...
  const handleSignOut = async () => {
    ...
    if (
      pathname.includes("cart-detail") ||
      pathname.includes("buy-now") ||
      ...
      <Header className="headerStyle">
        <div className="header">
          <div className="logo-wrapper">
            <div
              className={collapsed ? "inner-logo" : "inner-logo1"}
              onClick={() => {
                if (pathname !== "/") {
                  nav("/");
                }
          ...
          <div className="user">
            ...
            <div
              className="cart grow-button header-button"
              onClick={() => {
                nav("/cart-detail");
              }}
            >
            ...
            {!noSider && (
              <>
                {isOverlay && (
                  <Button
                    className="grow-button header-button"
                    type="text"
                    icon={
            ...
            <div
              ref={userSettingRef}
              data-user-setting
              className="user-setting rotate-button"
              onClick={handleUserSettingClick}
            >
              <SettingOutlined style={{ color: "#000" }} />
              <div
                className={`user-options ${userOptionsActive ? "active" : ""}`}
                data-user-options
                ref={userOptionsRef}
              >
                {isAuthen ? (
                  user.role == "ADMIN" ? (
                    <>
                      ...
                      <div className="user-option" onClick={handleSignOut}>
                        Đăng xuất
                      </div>
                    </>
                  ) : (
