...
const SiderMenu = (props) => {
  ...
  useEffect(() => {
    ...
    try {
      const fetchCategories = async () => {
        ...
        if (response.data) {
          let cateArray = response.data.map((item) => {
            return item.name;
          });
          setCategories(cateArray);
        } else {
          console.log("Can not get categories at siderMenu.js");
        }
      };
      fetchCategories();
    } catch (err) {
  ...
  }, [searchNameReducer, searchNameForm]);
  if (!categories) {
    return <LoadingTheme />;
  } else
    return (
      <div className="siderMenu">
        {isOverlay ? (
          <>
            ...
            <Form
              ...
              form={searchNameForm}
            >
              <Form.Item name="pSearchName" style={formItemStyle}>
        ...
        <Form onFinish={onFilterFinish} form={filterForm}>
          <div className="category-section">
            ...
            <div className="title small-title" style={{ position: "relative" }}>
              Thể loại
              <div
                className="reload-icon grow-button"
